<script>
  ...
  import SuccessSpin from "$lib/components/base/SuccessSpin.svelte";
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="/forgot_password" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Forgot password?</a>
                    </div>
                    ...
                    <SuccessSpin>Redirecting you to your dashboard...</SuccessSpin>
